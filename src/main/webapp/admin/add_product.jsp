				...
				<div class="md:flex  items-center justify-center">
					...
					<div class="w-full md:w-1/2 py-10 px-5 md:px-10">
						<div class="text-center mb-10">
							<h1 class="font-bold text-3xl text-gray-900">ADD PRODUCT</h1>
						...
						<div class="items-center">
							...
							<div class="flex -mx-3">
								<div class="w-full px-3 mb-5">
									<button
										class="block w-full max-w-xs mx-auto bg-green-400 hover:bg-indigo-700 focus:bg-indigo-400 text-white rounded-lg px-3 py-3 font-semibold">ADD
										NOW</button>
								</div>
							</div>
						</div>
